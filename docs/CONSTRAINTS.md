...
- GitHub Releases 产物边界已绑定：主仓库是唯一公开发布入口；公开 Release 不得包含后端源码、JAR/WAR、`.class` 或后端构建中间产物；后端 native 只能通过受校验的 artifact/asset 交接与复用。详见 `docs/adr/0012-github-releases-artifact-boundary.md`、`docs/adr/0013-release-workflow-token-and-artifact-policy.md`、`docs/adr/0014-release-native-build-budget-and-reuse-strategy.md` 和 `docs/RELEASE_RUNBOOK.md`。
