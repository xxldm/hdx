...
- 日期：2026-05-25
- 状态：已接受
- 修订：数据访问默认方案已由 ADR 0015 调整为 Spring JDBC / JdbcClient。
...
- 数据访问采用 Spring JDBC / JdbcClient；Spring Data JPA 的历史决策已由 ADR 0015 取代。
...
- `mvn test` 验证 Java 编译、单元测试和 JDBC/H2 冒烟测试。
