...
hdx-desktop-online-windows-x64-v0.1.0-setup.exe
hdx-desktop-online-windows-x64-v0.1.0.zip
hdx-desktop-online-linux-x64-v0.1.0.AppImage
hdx-desktop-online-stable.json

hdx-desktop-full-windows-x64-v0.1.0-setup.exe
hdx-desktop-full-windows-x64-v0.1.0.zip
hdx-desktop-full-linux-x64-v0.1.0.AppImage
hdx-desktop-full-stable.json
...
Updater JSON 按 Desktop flavor/channel 分开生成，例如 `hdx-desktop-online-stable.json` 与 `hdx-desktop-full-stable.json`。文件名本身不得使用 `latest`；稳定版客户端 endpoint 可以使用 GitHub `/releases/latest/download/<file>` 解析到当前稳定 Release。
