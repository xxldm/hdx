...
- 外部任务链接/编号：不适用
- 外部任务是否为主计划来源：否
- 当前状态：进行中；第 3 步认证与权限边界仍有后续风险，第 9 步部署、发布与环境管理仍缺正式 GitHub Release workflow、签名/公证/自动更新、release notes 和版本号策略。
...
- 正式 `.github/workflows/release.yml`。
- 主仓库 tag start、后端 release resolve、主仓库 release assemble、Web/Desktop/App 构建、draft、远端校验、publish 和失败清理的完整自动链路。
...
- 第 9 步：`docs/plans/completed/2026-06-08-public-license-backend-private-boundary.md`、`docs/plans/completed/2026-06-08-github-releases-artifact-boundary.md`、`docs/plans/completed/2026-06-08-release-manifest-schema.md`、`docs/plans/completed/2026-06-08-release-manifest-check-script.md`、`docs/plans/completed/2026-06-09-release-dry-run-workflow.md`、`docs/plans/completed/2026-06-09-release-workflow-token-artifact-policy.md`、`docs/plans/completed/2026-06-09-release-app-token-check.md`、`docs/plans/completed/2026-06-09-backend-native-artifact-ci.md`、`docs/plans/completed/2026-06-09-release-backend-artifact-check.md`、`docs/plans/completed/2026-06-09-release-draft-minimal-workflow.md`、`docs/plans/completed/2026-06-09-backend-native-artifact-expanded.md`
...
- 第 9 步完整真实 GitHub Release workflow、`backend-services-windows-x64`、完整 release artifact 上下文一致性、正式 publish、安装器签名、公证、自动更新、release notes 和版本号策略尚未实现。
