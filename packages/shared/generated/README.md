...
当前不提交生成物。后续如果从 OpenAPI 生成 TypeScript 类型或协议索引，必须遵守 `docs/adr/0007-openapi-typescript-generation-strategy.md`：第一阶段只生成类型，不生成完整 API client，不让浏览器绕过 Nuxt server BFF 直连后端。
